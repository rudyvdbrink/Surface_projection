function file = surface_project_raw(fname,hemi,fillholes,makefig,surface)
% data = surface_project_raw(file,hemi,fillholes,makefig,surface)
%
%   Input: 
...
%         projected file. No z-scoring is applied
%

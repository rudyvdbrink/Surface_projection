...
%% project a volumetric file on a very inflated surface, and plot it parcel-wise
...
[dat, ldat, rdat] = glasserize_cifti(fname,1,'sphere');

%% plot the myelin map on an inflated surface parcel-wise

[dat, ldat, rdat] = glasserize_cifti(fname,1,'inflated');
